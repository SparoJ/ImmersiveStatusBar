package com.pingan.apple.immersivestatusbar.widget.Banner;
...
import com.pingan.loader.ImageLoaderInterface;
...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public Banner setImages(List<Uri> imageUrls) {
        this.imageUrls = imageUrls;
        this.count = imageUrls.size();
        return this;
    }

    public void update(List<Uri> imageUrls, List<String> titles) {
    ...
    public void update(List<Uri> imageUrls) {
        this.imageUrls.clear();
        this.imageUrls.addAll(imageUrls);
        this.count = this.imageUrls.size();
        start();
    ...
    private void setImagesList(List<Uri> imageUrls) {
        ...
        for (int i = 0; i <= count + 1; ++i) {
            ...
            if (imageLoader != null) {
                imageLoader.loadNormalImg(mContext, url, imageView);
            } else {
